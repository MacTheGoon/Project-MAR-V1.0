...
_civilianUniforms = ["U_C_FormalSuit_01_gray_F","U_C_FormalSuit_01_tshirt_black_F","U_C_FormalSuit_01_black_F","UK3CB_ADC_C_Hunter_U_07","U_C_Man_casual_5_F","U_C_ArtTShirt_01_v5_F","U_C_Uniform_Scientist_02_formal_F","U_C_Uniform_Scientist_02_F","U_O_R_Gorka_01_F","U_BG_Guerilla3_1","U_BG_Guerilla2_2","U_BG_Guerilla2_1","U_BG_Guerilla2_3","U_I_C_Soldier_Bandit_4_F","U_I_C_Soldier_Bandit_1_F","U_I_C_Soldier_Bandit_2_F","U_I_C_Soldier_Bandit_5_F","U_I_C_Soldier_Bandit_3_F"];
...
_civilianHeadgear = ["H_Hat_brown","H_Cap_tan","USP_BASEBALL_CAP_DCU","H_Hat_tan","UK3CB_CHC_C_H_Can_Cap","H_Cap_oli","UK3CB_H_Beanie_02_BRN"];
...
_civilianBackpacks = ["UK3CB_B_Hiker","B_CivilianBackpack_01_Everyday_Black_F","B_CivilianBackpack_01_Sport_Blue_F","B_CivilianBackpack_01_Sport_Red_F","U_BG_Guerilla2_3","rhs_sidor","B_CivilianBackpack_01_Sport_Red_F","B_FieldPack_blk","B_FieldPack_cbr","B_FieldPack_khk","B_FieldPack_oucamo","G_FieldPack_Medic","B_Carryall_cbr","B_Carryall_khk","B_Carryall_oucamo","B_TacticalPack_blk","B_TacticalPack_rgr","B_TacticalPack_oli","B_Kitbag_cbr","B_Kitbag_rgr","B_Kitbag_sgg","B_Respawn_Sleeping_bag_blue_F","B_Respawn_Sleeping_bag_brown_F","B_Respawn_TentDome_F","B_Respawn_TentA_F","B_Parachute","ACE_NonSteerableParachute","ACE_TacticalLadder_Pack"];

//(Array of classnames) Safe vehicles to drive in (automatically inlcludes vehicles from the civilian factions above).
_civilianVehicleArray = ["UK3CB_C_Datsun_Open","UK3CB_C_Datsun_Closed","C_Van_01_box_F","UK3CB_ADC_C_LR_Open","C_Van_02_transport_F","C_Van_02_service_F","C_IDAP_Truck_02_F"];
...
_incogFactions = ["UK3CB_NFA_O"]; //Array of enemy factions whose items and vehicles will allow the player to impersonate the enemy
