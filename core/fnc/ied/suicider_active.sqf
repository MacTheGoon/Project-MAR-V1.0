...
private _expl1 = "ClaymoreDirectionalMine_Remote_Ammo" createVehicle (position _suicider);
_expl1 attachTo [_suicider, [-0.1, 0.1, 0.15], "Pelvis", true];
private _expl2 = "SatchelCharge_Remote_Ammo" createVehicle (position _suicider);
_expl2 attachTo [_suicider, [0, 0.15, 0.15], "Pelvis", true];
private _expl3 = "ClaymoreDirectionalMine_Remote_Ammo" createVehicle (position _suicider);
